---
title: "Quickstart: Run SEAM API and Make Your First Request"
sidebarTitle: "Quickstart"
description: "Install SEAM API, configure environment variables, start the server, and make your first authenticated request — all in under five minutes."
---
