...
description: "SEAM API's validate middleware enforces field types, lengths, and patterns on request body, params, and query string before the request reaches any controller."
---
