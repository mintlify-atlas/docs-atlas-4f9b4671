...
description: "Authenticate a Socket.IO client with JWT and listen to operation:progress and data:changed events to drive loaders and real-time UI updates in SEAM API."
---
