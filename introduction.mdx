...
description: "SEAM API is a Node.js/Express 5 REST API with JWT auth, RBAC, and Socket.IO real-time progress events for building secure web application backends."
---
