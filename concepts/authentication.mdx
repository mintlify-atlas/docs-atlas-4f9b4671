---
title: "JWT Authentication in SEAM API: Tokens, Headers, Sockets"
sidebarTitle: "Authentication"
description: "SEAM API uses JWT for authentication. Learn how tokens are issued at login, verified on each request, and forwarded via the Authorization header."
---
