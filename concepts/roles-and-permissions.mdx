...
description: "SEAM API enforces RBAC using URI-based permissions. Each route verifies that the authenticated user's role holds the required permission before proceeding."
---
