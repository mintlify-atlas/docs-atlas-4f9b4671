---
title: "PUT /api/v1/users/:id — Update User Account by ID"
sidebarTitle: "Update User"
description: "Updates one or more fields on an existing user account. All body fields are optional. Requires JWT and the PUT /api/v1/users/:id role permission."
---
