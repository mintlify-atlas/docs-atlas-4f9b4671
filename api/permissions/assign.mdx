---
title: "Assign Permission to a Role — POST /api/v1/permission/assign"
sidebarTitle: "Assign Permission"
description: "Links a permission to a role via permissionXRole. Requires JWT and POST /api/v1/permission/assign permission. Duplicate entries are silently ignored."
---
