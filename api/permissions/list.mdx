---
title: "GET /api/v1/permission — List All Permissions"
sidebarTitle: "List Permissions"
description: "Returns all registered permissions in the system. Requires JWT authentication only. Use this endpoint to discover available nameUri values for role assignment."
---

Returns every permission registered in the system, ordered by `idPermission`. No role permission check is applied — any authenticated user can call this endpoint. This is intentional so that administrators can browse available permissions when building role configurations.
