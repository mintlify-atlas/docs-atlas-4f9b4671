---
title: "Get Permissions by Role — GET /api/v1/permission/getByRoleId"
sidebarTitle: "Get by Role"
description: "Returns all permissions assigned to a role, identified by roleId query param. Requires JWT only. Returns an empty array if no permissions are assigned."
---
...
```json Role With No Permissions Assigned
{
  "success": true,
  "message": "Permiso obtenido por rol.",
  "data": []
